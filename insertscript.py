...
def populate_database():
    ...
    sport_types = [
        SportType(name="100m Sprint", unit="seconds", world_record=9.58, olympic_record=9.63),
        SportType(name="Long Jump", unit="meters", world_record=8.95, olympic_record=8.90),
        SportType(name="High Jump", unit="meters", world_record=2.45, olympic_record=2.39),
        SportType(name="Marathon", unit="hours", world_record=2.01, olympic_record=2.06),
        SportType(name="Shot Put", unit="meters", world_record=23.37, olympic_record=22.52),
    ]
    ...
    athletes = [
        ...
        Athlete(full_name="Ryan Crouser", country="USA", birth_year=1992, victories=4),
    ]
    db.add_all(athletes)
    db.commit()
    ...
    results = [
        ...
        Result(sport_type_id=5, athlete_id=5, competition_name="Olympics 2021", result_value=23.30, 
               competition_date=datetime(2021, 8, 5).date(), location="Tokyo"),
    ]
    db.add_all(results)
    db.commit()
